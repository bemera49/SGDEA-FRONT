...
import { tableHeadersAsociadas, tableHeadersCuentasAsociadas, tableHeadersProceso } from './utils/table-headers';
...
@Component({
  selector: 'app-solicitud-visto-bueno',
  templateUrl: './solicitud-visto-bueno.component.html',
  styleUrls: ['./solicitud-visto-bueno.component.css']
})
export class SolicitudVistoBuenoComponent implements OnInit {
