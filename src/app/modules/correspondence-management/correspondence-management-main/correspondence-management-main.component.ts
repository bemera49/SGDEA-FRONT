...
@Component({
  selector: "app-correspondence-management-main",
  templateUrl: "./correspondence-management-main.component.html",
  styleUrls: ["./correspondence-management-main.component.css"],
})
export class CorrespondenceManagementMainComponent implements OnInit, OnDestroy {
  /** Variables para el componente top-nav-bar */
  topNavBarTitle: string = "Gestión correspondencia"; // i18n
  ...
  subMenuTitle: string;
  subMenuActive: string = "correspondenceManagement";
