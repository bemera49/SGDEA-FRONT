...
const routes: Routes = [
  ...
  /** Módulos donde se necesita estar logueado */
  {
    ...
    children: [
      ...
      { path: 'filing', loadChildren: () => import('./modules/filing/filing.module').then(m => m.FilingModule) },
      { path: 'e-filing', loadChildren: () => import('./modules/e-filing/e-filing.module').then(m => m.EFilingModule) },
      { path: 'setting', loadChildren: () => import('./modules/settings-app/settings-app.module').then(m => m.SettingsAppModule) },
      { path: 'documentManagement', loadChildren: () => import('./modules/document-management/document-management.module').then(m => m.DocumentManagementModule) },
      { path: 'correspondenceManagement', loadChildren: () => import('./modules/correspondence-management/correspondence-management.module').then(m => m.CorrespondenceManagementModule) },
      { path: 'archiveManagement', loadChildren: () => import('./modules/archive-management/archive-management.module').then(m => m.ArchiveManagementModule) },
      ...
      { path: 'predial', loadChildren: () => import('./modules/predial/predial.module').then(m => m.PredialModule), },
      { path: 'quality', component: QualityMainComponent, },
      { path: 'juridica', loadChildren: () => import('./modules/juridica/juridica.module').then(m => m.JuridicaModule), },
      { path: 'signin', loadChildren: () => import('./modules/management-processing/management-processing.module').then(m => m.ManagementProcessingModule), },
      { path: 'help', component: HelpMainComponent, },
      { path: 'users', component: UsersMainComponent, },
      { path: 'ocupational', loadChildren: () => import('./modules/ocupational/ocupational.module').then(m => m.OcupationalModule), },
