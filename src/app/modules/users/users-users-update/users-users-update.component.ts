  ...
  submitFormReceive(data) {
    ...
    this.encryptService
      .generateRouteGetParams(
        environment.apiUrl + environment.versionApiDefault + "user/update",
        data.dataForm,
        this.authorization,
      )
      .then((res) => {
        ...
        /** Comsumo de servicio  */
        this.http
          .post(this.urlEndSend, data.dataFile, {
          ...
          .subscribe(
              ...
              switch (event.type) {
                ...
                case HttpEventType.Response: // Cuando termina la carga
                  if (event.body) {
                    ...
                    this.encryptService
                      .decryptAES(
                        this.responseServiceFormSubmit.encrypted,
                        this.authorization,
                      )
                      .then((res) => {
                        ...
                        this.globalAppService
                          .resolveResponse(this.responseServiceDecrypt, false)
                          .then((res) => {
                            ...
                            if (responseResolveResponse == true) {
                              this.sweetAlertService.showNotification(
                                "success",
                                this.responseServiceDecrypt.message,
                              );
                              /**
                              ...
                              if (!this.disablesocket)
                                 ...
                                 */
                                this.dataListModuleName = localStorage.getItem(
                                  environment.hashDataListModule,
                                );
                              this.dataListModuleNameNoAES =
                                this.restService.decryptAES(
                                  this.dataListModuleName,
                                  this.authorization,
                                );

                              if (
                                this.dataListModuleNameNoAES ==
                                this.responseServiceDecrypt.dataModule
                              ) {
                                localStorage.removeItem(
                                  environment.hashDataList,
                                );
                                this.restService.decryptAES(
                                  this.responseServiceDecrypt.dataListUser,
                                  this.authorization,
                                );
                              }
                              /**
            ...
            (err) => {
              ...
              this.globalAppService
                .resolveResponseError(this.responseServiceErr, false)
                .then((res) => {});
