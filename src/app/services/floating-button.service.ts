...
export class FloatingButtonService {
  ...
  @Output() clickChangeTransactionShippingElectronic: EventEmitter<any> = new EventEmitter<any>();
  ...
  changeShippingElectonic(data, dataObserva) {
    let dataDelivered = {
      ButtonSelectedData: data,
      dataObserva: dataObserva,
    };
    this.clickChangeTransactionShippingElectronic.emit(dataDelivered);
  }
