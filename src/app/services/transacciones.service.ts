...
export class TransaccionesService {
  ...
  transactionTempleteCorrespondence(
    dataIdRadicados: any,
    authorization: any,
    action = "correspondenceTemplate",
  ) {
    let route = "";
    ...
    this.restService
      .restPost(this.versionApi + route, params, authorization)
      .subscribe(
        (res) => {
            ...
            .then((res) => {
              ...
              if (responseResolveResponse == true) {
                if (this.resServices.datafile) {
                  this.downloadFile(
                    this.resServices.datafile,
                    this.resServices.nombreDoc,
                  );
                }
        ...
        (err) => {
          ...
          this.globalAppService
            .resolveResponseError(this.resServicesErr)
            .then((res) => {});
        },
      );
  }
   ...
   */
  downloadFile(file: any, nameDownload: any) {
   ...
   * @param dataIdRadicados array id radicados
   */
  transactionReturnDelivery(data: any, dataIdRadicados: any) {
                  ...
                  .then((res) => {
                    ...
                    if (responseResolveResponse == true) {
                      for (let key in this.resServices.notificacion) {
                        this.sweetAlertService.showNotification(
                          this.resServices.notificacion[key]["type"],
                          this.resServices.notificacion[key]["message"],
                        );
                      }
                    }
                  });
   ...
   * @param dataIdRadicados array id radicados
   */
  transactionReturnFiling(dataIdRadicados: any, observacion: any, action: any) {
    // Cambia el los mensajes de texto del componete para confirmar la eliminacion
    this.globalAppService.text18nGet().then((res) => {
      this.resSerLenguage = res;
      // console.log( this.resSerLenguage );
   ...
   * @param dataIdRadicados array id radicados
   */
  transactionSchedule(data: any, dataIdRadicados: any) {
    let params = {
      data: data,
      ButtonSelectedData: dataIdRadicados,
    };
    ...
    this.restService
      ...
      .subscribe(
        ...
        (err) => {
          ...
          // Evaluar respuesta de error del servicio
          this.globalAppService
            .resolveResponseError(this.resServices)
            .then((res) => {});
        },
      );
  }
