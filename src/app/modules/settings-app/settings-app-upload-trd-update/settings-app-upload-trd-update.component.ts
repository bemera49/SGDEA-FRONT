...
@Component({
  selector: 'app-settings-app-upload-trd-update',
  templateUrl: './settings-app-upload-trd-update.component.html',
  styleUrls: ['./settings-app-upload-trd-update.component.css']
})
export class SettingsAppUploadTrdUpdateComponent implements OnInit {
  ...
  textForm = 'Actualizar configuración TRD'; // i18n
  // Redired path
  ...
  submitFormReceive(data) {
    ...
    this.restService.restPut( this.versionApi + 'configuracionApp/cg-trd/update', data, this.authorization)
      .subscribe((res) => {
