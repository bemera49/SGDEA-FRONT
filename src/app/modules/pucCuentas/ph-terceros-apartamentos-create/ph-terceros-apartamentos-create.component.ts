...
@Component({
  selector: "app-ph-terceros-apartamentos-create",
  templateUrl: "./ph-terceros-apartamentos-create.component.html",
  styleUrls: ["./ph-terceros-apartamentos-create.component.css"],
})
export class PhTercerosApartamentosCreateComponent {
  // Autorizacion de localstorage
  authorization: string;
  // Nombre del boton
  textButtonForm = "Crear";
  // Nombre del formulario
  textFormTercero = "Crear Apartamento";
  /** BreadcrumbOn  */
  breadcrumbOn = [
    { name: "Propiedad Horizontal", route: "/pucCuentas" },
    {
      name: "Catalogo Terceros",
      route: "/pucCuentas/ph-terceros-apartamentos-create",
    },
  ];
  ...
  submitFormReceive(data) {
    ...
    this.restService
      .restPost(
        versionApi + "phTerceroApartamentos/ph-terceros-apartamentos/create",
        data,
        this.authorization,
      )
      .subscribe(
