...
import { ListFile } from '../Interfaces/list-observation';

@Injectable({
  providedIn: 'root'
})
export class PlantillaShowObservationService {
  ...
  obtenerDatos(body: ListFile): Observable<any> {
    return this.http.post(`${this.apiUrl}verificaciones`,body,  this.headerAuthServices.getHttpHeadersOptions());
  }
