...
@Component({
  selector: "app-ph-terceros-create",
  templateUrl: "./ph-terceros-create.component.html",
  styleUrls: ["./ph-terceros-create.component.css"],
})
export class PhTercerosCreateComponent {
  // Autorizacion de localstorage
  authorization: string;
  // Nombre del boton
  textButtonForm = "Crear";
  // Nombre del formulario
  textFormTercero = "Crear tercero";
  /** BreadcrumbOn  */
  breadcrumbOn = [
  ...
  submitFormReceive(data) {
    ...
    this.restService
      .restPost(
        versionApi + "phTercero/ph-tercero/create",
        data,
        this.authorization,
      )
      .subscribe(
