...
@Component({
  selector: 'app-upload-mass-transfer',
  templateUrl: './upload-mass-transfer.component.html',
  styleUrls: ['./upload-mass-transfer.component.css']
})
export class UploadMassTransferComponent implements OnInit, OnDestroy {
  ...
  @Input() textForm = 'Traslado masivo';
  // Valida tipo texto
