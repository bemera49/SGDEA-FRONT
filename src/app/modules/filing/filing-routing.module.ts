...
import { FillingCoopWorksComponent } from './filling-coop-works/filling-coop-works.component';
 ...
 const routes: Routes = [
      ...
      // SDQD 
      { path: 'sdqs-requests-index', component: FilingRequestDistributionIndexComponent },
      { path: 'filing-update-request/:id/:menu', component: FilingUpdateRequestComponent },
      // Página web
      {path: 'filing-web-index',component: FilingWebPageIndexComponent,},
      { path: 'filing-update-web-page/:id', component: FilingUpdateRequestComponent },
      // Radicados Email
      {path: 'filing-radicados-email-index',component: FilingRadicadosEmailIndexComponent},
      { path: 'filing-update-radicados-email/:id', component: FilingUpdateRequestComponent },
