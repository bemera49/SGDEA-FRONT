...
@Component({
  selector: 'app-settings-app-user-groups-update',
  templateUrl: './settings-app-user-groups-update.component.html',
  styleUrls: ['./settings-app-user-groups-update.component.css']
})
export class SettingsAppUserGroupsUpdateComponent implements OnInit {
  ...
  textForm = 'Actualizar grupo de usuarios'; // i18n
  // Ruta a redirigir
  ...
  submitFormReceive(data) {
    ...
    this.restService.restPut( this.versionApi + 'configuracionApp/grupos-usuarios/update', data, this.authorization)
      .subscribe((res) => {
