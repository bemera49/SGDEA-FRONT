...
@Component({
  selector: "app-settings-app-main",
  templateUrl: "./settings-app-main.component.html",
  styleUrls: ["./settings-app-main.component.css"],
})
export class SettingsAppMainComponent implements OnInit, OnDestroy {
  /** Variables para el componente top-nav-bar */
  topNavBarTitle: string = "Configuración"; // i18n
