...
import { ListFile } from '../Interfaces/list-aclaration';

@Injectable({
  providedIn: 'root'
})
export class PlantillaShowAclarationService {
  ...
  obtenerDatos(body: ListFile): Observable<any> {
    return this.http.post(`${this.apiUrl}aclaraciones`,body,  this.headerAuthServices.getHttpHeadersOptions());
  }
