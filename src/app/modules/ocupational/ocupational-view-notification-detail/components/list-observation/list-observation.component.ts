...
import { PlantillaShowObservationService } from '@app/modules/ocupational/ocupational-view-notification-detail/components/list-observation/services/plantilla-show-observation.service';
import { RestService } from '@app/services/rest.service';
import { saveAs } from 'file-saver';
import { Items } from "../../../ocupational-main/components/sub-menu-ocupational/items";
import { ListFile, file } from './Interfaces/list-observation';
...
export class ListObservationComponent implements OnInit {
  ...
  constructor(
    private plantillaShowService: PlantillaShowObservationService,
