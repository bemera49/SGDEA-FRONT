...
export class DesignationsService {
  ...
  postasignAnalyst(body: RequestDesignation): Observable<any> {
    return this.http.post(`${this.URL}api/sgc/solicitud/add/analista`,body,  this.headerAuthServices.getHttpHeadersOptions());
  }
