...
export class AnalysisRequestsService {
  ...
  putUpdateAnalysis(body: FormData): Observable<ResponseAnalysisUpdate> {
    ...
    return this.http.post<ResponseAnalysisUpdate>(`${this.URL}api/sgc/plan-analisis/update`, body, this.headerAuthServices.getHttpHeadersOptions());
  }

  updateMeets(body: ResponseAnalysisUpdate): Observable<ResponseAnalysisUpdate> {
    return this.http.put<ResponseAnalysisUpdate>(`${this.URL}api/sgc/plan-analisis/updateMeet`, body, this.headerAuthServices.getHttpHeadersOptions());
  }

  updateConfirm(body: ResponseAnalysisUpdate): Observable<ResponseAnalysisUpdate> {
    return this.http.put<ResponseAnalysisUpdate>(`${this.URL}api/sgc/plan-analisis/updateConfirm`, body, this.headerAuthServices.getHttpHeadersOptions());
  }
