...
@Component({
  ...
  styleUrls: ['./quality-main.component.css']
})
export class QualityMainComponent implements OnInit, OnDestroy {

  /** Variables para el componente top-nav-bar */
  topNavBarTitle: string = "Calidad"; // i18n
