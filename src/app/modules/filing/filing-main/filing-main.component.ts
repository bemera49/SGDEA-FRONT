...
@Component({
  selector: "app-filing-main",
  templateUrl: "./filing-main.component.html",
  styleUrls: ["./filing-main.component.css"],
})
export class FilingMainComponent implements OnInit, OnDestroy {
  /** Variables para el componente top-nav-bar */
  topNavBarTitle: string = "Radicación"; // i18n
