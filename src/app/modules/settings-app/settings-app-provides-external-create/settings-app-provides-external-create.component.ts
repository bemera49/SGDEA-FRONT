...
@Component({
  selector: 'app-settings-app-provides-external-create',
  templateUrl: './settings-app-provides-external-create.component.html',
  styleUrls: ['./settings-app-provides-external-create.component.css']
})
export class SettingsAppProvidesExternalCreateComponent implements OnInit {

  // Autorizacion de localstorage
  authorization: string;
  // Nombre del formulario
  textForm = 'Nuevo usuario interoperabilidad'; // i18n
  // Ruta a redirigir
  ...
  submitFormReceive(data) {
    ...
    this.restService.restPost( this.versionApi + 'configuracionApp/cg-proveedores-externos/create', data, this.authorization)
      .subscribe((res) => {
