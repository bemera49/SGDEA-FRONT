...
@Component({
  selector: 'app-juridica-main',
  templateUrl: './juridica-main.component.html',
  styleUrls: ['./juridica-main.component.css'],
}) 
export class JuridicaMainComponent implements OnInit, OnDestroy {
  /** Variables para el componente top-nav-bar */
  topNavBarTitle: string = "Jurídica"; // i18n
  ...
  subMenuTitle: string;
  subMenuActive: string = "juridical";
