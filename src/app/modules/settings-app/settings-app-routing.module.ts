...
const routes: Routes = [
  ...
  { path: "templates-update/:id", component: SettingsAppTemplatesCreateComponent },
  // Variables templates
  ...
  { path: "reemplazo-vacaciones", component: VacacionesModalComponent },

  { path: "administracion-metadatos", component: AdministracionMetadatosComponent },

  { path: "time-request-index", component: SettingAppTimeRequestIndexComponent },
  { path: "time-request-create", component: SettingAppCreateTimeRequestComponent },
  { path: "time-request-update/:id", component: SettingAppCreateTimeRequestComponent },
