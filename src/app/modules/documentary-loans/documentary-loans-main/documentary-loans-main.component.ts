...
@Component({
  selector: "app-documentary-loans-main",
  templateUrl: "./documentary-loans-main.component.html",
  styleUrls: ["./documentary-loans-main.component.css"],
})
export class DocumentaryLoansMainComponent implements OnInit, OnDestroy {
  /** Variables para el componente top-nav-bar */
  topNavBarTitle: string = "Préstamos documentales"; // i18n
  ...
  subMenuTitle: string;
  subMenuActive: string = "documentaryLoans";
