...
@Component({
  selector: 'app-ocupational-main',
  templateUrl: './ocupational-main.component.html',
  styleUrls: ['./ocupational-main.component.css']
})
export class OcupationalMainComponent implements OnInit, OnDestroy {

  /** Variables para el componente top-nav-bar */
  topNavBarTitle: string = "Ocupacional"; // i18n
  ...
  subMenuTitle: string;
  subMenuActive: string = "ocupational";
