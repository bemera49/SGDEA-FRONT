...
export class UsersRolesIndexComponent implements OnInit {
  ...
  routeLoadDataTablesService: string =
    environment.versionApiDefault + "roles/roles/index";
  dtTitles: any = [
  ...
  menuButtonsSelectOne: any = [
    ...
    {
      icon: "assignment",
      title: "Asignación tipos documentales",
      action: "documentaryTypes",
      data: "",
    },
    {
      icon: "description",
      title: "Asignación tipos de radicado",
      action: "filingTypes",
      data: "",
    },
  ];
  ...
  routeChangeStatus: string =
    environment.versionApiDefault + "roles/roles/change-status";
  ...
  menuReceiveData(event) {
    switch (event.action) {
      ...
      case "documentaryTypes":
        ...
        this.router.navigate([
          "/" +
            this.initBotonDocumentaryRoute +
            "/" +
            this.eventClickButtonSelectedData[0]["data"][0] +
            "/" +
            this.eventClickButtonSelectedData[0]["data"][1],
        ]);
        break;
      case "filingTypes":
