...
@Component({
  selector: 'app-settings-app-providers-create',
  templateUrl: './settings-app-providers-create.component.html',
  styleUrls: ['./settings-app-providers-create.component.css']
})
export class SettingsAppProvidersCreateComponent implements OnInit {

  // Autorizacion de localstorage
  authorization: string;
  // Nombre del formulario
  textForm = 'Nuevo proveedor'; // i18n
  // Ruta a redirigir
  ...
  submitFormReceive(data) {
    ...
    this.restService.restPost( this.versionApi + 'configuracionApp/cg-proveedores/create', data, this.authorization)
      .subscribe((res) => {
