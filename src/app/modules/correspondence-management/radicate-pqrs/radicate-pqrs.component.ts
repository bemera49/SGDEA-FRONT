...
@Component({
  selector: 'app-radicate-pqrs',
  templateUrl: './radicate-pqrs.component.html',
  styleUrls: ['./radicate-pqrs.component.css']
})
export class RadicatePqrsComponent implements OnInit {

  /** Initial List */
  initCardHeaderStatus = true;
  initCardHeaderIcon = 'pan_tool';
  initCardHeaderTitle = 'Listado de radicados';
  route: string = 'radicate'; // Nombre del módulo donde se esta accediendo al initialList
  // Ruta a redirigir
  redirectionPath = '/correspondenceManagement/radicate-pqrs';
  /** Formulario index */
  ...
  breadcrumbRouteActive = 'Radicación Pqrs';
