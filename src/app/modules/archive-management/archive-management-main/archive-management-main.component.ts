...
@Component({
  selector: "app-archive-management-main",
  templateUrl: "./archive-management-main.component.html",
  styleUrls: ["./archive-management-main.component.css"],
})
export class ArchiveManagementMainComponent implements OnInit, OnDestroy {
  /** Variables para el componente top-nav-bar */
  topNavBarTitle: string = "Gestión de archivo"; // i18n
  ...
  subMenuTitle: string;
  subMenuActive: string = "archiveManagement";
