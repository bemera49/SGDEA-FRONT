...
@Component({
  selector: "app-puc-cuentas-update",
  templateUrl: "./puc-cuentas-update.component.html",
  styleUrls: ["./puc-cuentas-update.component.css"],
})
export class PucCuentasUpdateComponent {
  // Nombre del boton
  ...
  /** BreadcrumbOn  */
  breadcrumbOn = [
    { name: "Plan de cuentas", route: "/pucCuentas" },
  ...
  submitFormReceive(data) {
    ...
    this.restService
      .restPut(
        versionApi + "pucCuentas/puc-cuentas/update",
        data,
        this.authorization,
      )
      .subscribe(
