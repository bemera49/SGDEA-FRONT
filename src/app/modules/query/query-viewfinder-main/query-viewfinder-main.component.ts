...
@Component({
  selector: "app-query-viewfinder-main",
  templateUrl: "./query-viewfinder-main.component.html",
  styleUrls: ["./query-viewfinder-main.component.css"],
})
export class QueryViewfinderMainComponent implements OnInit, OnDestroy {
  /** Variables para el componente top-nav-bar */
  topNavBarTitle: string = "Consultas"; // i18n
