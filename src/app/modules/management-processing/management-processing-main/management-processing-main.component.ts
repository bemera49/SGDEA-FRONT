...
@Component({
  selector: 'app-management-processing-main',
  templateUrl: './management-processing-main.component.html',
  styleUrls: ['./management-processing-main.component.css']
})
export class ManagementProcessingMainComponent implements OnInit {

   /** Variables para el componente top-nav-bar */
   topNavBarTitle: string = "Gestión y tramite"; // i18n
   ...
   subMenuTitle: string;
   subMenuActive: string = "managementProcessing";
