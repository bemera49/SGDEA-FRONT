...
@Component({
  selector: 'app-settings-app-certified-signatures-view',
  templateUrl: './settings-app-certified-signatures-view.component.html',
  styleUrls: ['./settings-app-certified-signatures-view.component.css']
})
export class SettingsAppCertifiedSignaturesViewComponent implements OnInit {
  ...
  textFormView = 'Detalle Proveedor Firma Certificada'; // i18n
  /** Datos que solicita el ViewList */
  // Ruta a consultar en el ViewList
  reuteLoadView: string = 'configuracionApp/cg-firmas-certificadas/view';
  // Ruta a actualizar en el ViewList
  routeBotonUpdateView: string = '/setting/certified-signatures-update/';
  // Icono del ViewList
