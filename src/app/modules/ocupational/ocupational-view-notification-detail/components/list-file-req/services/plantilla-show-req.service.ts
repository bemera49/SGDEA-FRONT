...
import { ListFile } from '../Interfaces/list-file-req';

@Injectable({
  providedIn: 'root'
})
export class PlantillaShowReqService {
  ...
  obtenerDatos(body: ListFile): Observable<any> {
    return this.http.post(`${this.apiUrl}anexos`,body,  this.headerAuthServices.getHttpHeadersOptions());
  }
