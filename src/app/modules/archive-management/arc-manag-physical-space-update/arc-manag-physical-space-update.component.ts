...
@Component({
  selector: 'app-arc-manag-physical-space-update',
  templateUrl: './arc-manag-physical-space-update.component.html',
  styleUrls: ['./arc-manag-physical-space-update.component.css']
})
export class ArcManagPhysicalSpaceUpdateComponent implements OnInit {
  ...
  textForm = 'Datos del edificio'; // i18n
  // Ruta a redirigir
  ...
  submitFormReceive(data) {
    ...
    data['numeroGaPiso'] = data['numeroPiso'] ;

    // Cargando true
    this.sweetAlertService.sweetLoading();

    this.restService.restPut( this.versionApi + 'gestionArchivo/espacio-fisico/update', data, this.authorization)
      .subscribe((res) => {
