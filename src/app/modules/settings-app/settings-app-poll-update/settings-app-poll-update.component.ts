...
@Component({
  selector: 'app-settings-app-poll-update',
  templateUrl: './settings-app-poll-update.component.html',
  styleUrls: ['./settings-app-poll-update.component.css']
})
export class SettingsAppPollUpdateComponent implements OnInit {
  ...
  textForm = 'Actualizar encuesta'; // i18n
  // Ruta a redirigir
  ...
  statusButtonAdd: boolean = true; // Muestra boton de agregar pregunta
  /**
  ...
  submitFormReceive(data) {
    ...
    this.restService.restPut( this.versionApi + 'configuracionApp/encuestas/update', data, this.authorization)
      .subscribe((res) => {
