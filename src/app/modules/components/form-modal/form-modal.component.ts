...
export class modalDialog implements OnInit, AfterViewChecked {
  ...
  constructor(
    ...
    */
    this.moduleForm = this.formBuilder.group({
      ...
      observacion: new UntypedFormControl('Envió radicado, en espera por actualización de estado por parte del proveedor.', Validators.compose([
        //Validators.required,
      ])),
  ...
  submitForm() {
    ...
    this.moduleForm.value.idCgRegional = 1
    this.moduleForm.value.idCgEnvioServicio = 1
    this.moduleForm.value.idCgProveedores = 1
