...
@Component({
  selector: 'app-settings-app-user-groups-create',
  templateUrl: './settings-app-user-groups-create.component.html',
  styleUrls: ['./settings-app-user-groups-create.component.css']
})
export class SettingsAppUserGroupsCreateComponent implements OnInit {

  // Autorizacion de localstorage
  authorization: string;
  // Nombre del formulario
  textForm = 'Nuevo grupo'; // i18n
  // Ruta a redirigir
  ...
  submitFormReceive(data) {
    ...
    this.restService.restPost( this.versionApi + 'configuracionApp/grupos-usuarios/create', data, this.authorization)
      .subscribe((res) => {
