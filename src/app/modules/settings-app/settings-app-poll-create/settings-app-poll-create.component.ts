...
@Component({
  selector: 'app-settings-app-poll-create',
  templateUrl: './settings-app-poll-create.component.html',
  styleUrls: ['./settings-app-poll-create.component.css']
})
export class SettingsAppPollCreateComponent implements OnInit {

  // Autorizacion de localstorage
  authorization: string;
  // Nombre del formulario
  textForm = 'Nueva encuesta'; // i18n
  // Ruta a redirigir
  ...
  submitFormReceive(data) {
    ...
    this.restService.restPost( this.versionApi + 'configuracionApp/encuestas/create', data, this.authorization)
      .subscribe((res) => {
