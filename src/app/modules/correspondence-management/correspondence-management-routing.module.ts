...
const routes: Routes = [
      ...
      // Distribution and Shipping
      { path: 'distribution-shipping-index-ee/:id', component: CorManagDistributionShippingIndexComponent },
      { path: 'distribution-shipping-index-ef/:id', component: CorManagDistributionShippingIndexComponent },
      { path: 'distribution-shipping-index-ne/:id', component: CorManagDistributionShippingIndexComponent },
      { path: 'distribution-shipping-index-nf/:id', component: CorManagDistributionShippingIndexComponent },
