...
@Component({
  selector: 'app-settings-app-region-update',
  templateUrl: './settings-app-region-update.component.html',
  styleUrls: ['./settings-app-region-update.component.css']
})
export class SettingsAppRegionUpdateComponent implements OnInit {
  ...
  textForm = 'Actualizar regional'; // i18n
  // Ruta a redirigir
  ...
  submitFormReceive(data) {
    ...
    this.restService.restPut( this.versionApi + 'configuracionApp/regionales/update', data, this.authorization)
      .subscribe((res) => {
