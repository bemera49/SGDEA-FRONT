...
export class UsersUsersIndexComponent implements OnInit {
  ...
  messageExpress(){
    ...
    this.restService.restPost(this.versionApi + 'user/comercial', params, this.authorization).subscribe((res) => {
      ...
      this.globalAppService.resolveResponse(this.resServicessgdaVal, false).then((res) => {
      ...
      this.globalAppService.resolveResponseError(this.resServicessgdaValErr).then((res) => { });
    }
    );
