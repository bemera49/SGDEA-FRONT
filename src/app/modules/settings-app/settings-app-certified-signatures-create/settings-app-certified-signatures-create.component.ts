...
@Component({
  selector: 'app-settings-app-certified-signatures-create',
  templateUrl: './settings-app-certified-signatures-create.component.html',
  styleUrls: ['./settings-app-certified-signatures-create.component.css']
})
export class SettingsAppCertifiedSignaturesCreateComponent implements OnInit {

  // Autorizacion de localstorage
  authorization: string;
  // Nombre del formulario
  textForm = 'Nuevo Proveedor Firma Certificada'; // i18n
  // Ruta a redirigir
  ...
  submitFormReceive(data) {
    ...
    this.restService.restPost( this.versionApi + 'configuracionApp/cg-firmas-certificadas/create', data, this.authorization)
      .subscribe((res) => {
