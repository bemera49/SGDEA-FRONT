...
import { PlantillaShowReqService } from '@app/modules/ocupational/ocupational-view-notification-detail/components/list-file-req/services/plantilla-show-req.service';
import { RestService } from '@app/services/rest.service';
import { saveAs } from 'file-saver';
import { Items } from "../../../ocupational-main/components/sub-menu-ocupational/items";
import { ListFile, file } from './Interfaces/list-file-req';

@Component({
  selector: 'app-list-file-req',
  templateUrl: './list-file-req.component.html',
  styleUrls: ['./list-file-req.component.css']
})
export class ListFileReqComponent implements OnInit {
  ...
  constructor(
    private plantillaShowService: PlantillaShowReqService,
