...
@Component({
  selector: "app-doc-manag-main",
  templateUrl: "./doc-manag-main.component.html",
  styleUrls: ["./doc-manag-main.component.css"],
})
export class DocManagMainComponent implements OnInit, OnDestroy {
  /** Variables para el componente top-nav-bar */
  topNavBarTitle: string = "Gestión documental"; // i18n
  ...
  subMenuTitle: string;
  subMenuActive: string = "documentManagement";
