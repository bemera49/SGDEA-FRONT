...
@Component({
  selector: 'app-settings-app-times-response-update',
  templateUrl: './settings-app-times-response-update.component.html',
  styleUrls: ['./settings-app-times-response-update.component.css']
})

export class SettingsAppTimesResponseUpdateComponent implements OnInit {


  // Nombre del boton
  textButtonForm = 'Actualizar';
  // Nombre del formulario
  textFormRol = 'Modificar horario laboral';
  // Autentificacion
  ...
  submitFormReceive(data) {
    ...
    this.restService.restPut(versionApi + 'configuracionApp/cg-tiempos-respuesta/update', data, this.authorization)
      .subscribe((res) => {
