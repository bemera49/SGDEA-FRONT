...
@Component({
  selector: 'app-settings-app-non-working-update',
  templateUrl: './settings-app-non-working-update.component.html',
  styleUrls: ['./settings-app-non-working-update.component.css']
})
export class SettingsAppNonWorkingUpdateComponent implements OnInit {
  ...
  textForm = 'Actualizar día no laborado'; // i18n
  // Ruta a redirigir
  ...
  submitFormReceive(data) {
    ...
    this.restService.restPut( this.versionApi + 'configuracionApp/dias-no-laborados/update', data, this.authorization)
      .subscribe((res) => {
