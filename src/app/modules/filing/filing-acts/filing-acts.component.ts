...
@Component({
  selector: 'app-filing-acts',
  templateUrl: './filing-acts.component.html',
  styleUrls: ['./filing-acts.component.css']
})
export class FilingActsComponent implements OnInit {
  ...
  initCardHeaderTitle = 'Listado de actos administrativos';
  ...
  dtTitles: any = [
    { 'title': 'Semáforo', 'data': 'semaforo'},
    { 'title': 'Tipo de solicitud', 'data': 'TipoRadicado' },
    { 'title': 'Numero de Acto', 'data': 'numeroRadiRadicado' },
    { 'title': 'Fecha Creación', 'data': 'creacionRadiRadicado' },
    { 'title': 'Fecha máxima', 'data': 'fechaVencimientoRadiRadicados' },
  ];
