...
@Component({
  selector: 'app-settings-app-third-management-update',
  templateUrl: './settings-app-third-management-update.component.html',
  styleUrls: ['./settings-app-third-management-update.component.css']
})
export class SettingsAppThirdManagementUpdateComponent implements OnInit {
  ...
  textForm = 'Actualizar tercero'; // i18n
  // Ruta a redirigir
  ...
  submitFormReceive(data) {
    ...
    this.restService.restPut( this.versionApi + 'configuracionApp/cg-gestion-terceros/update', data, this.authorization)
      .subscribe((res) => {
