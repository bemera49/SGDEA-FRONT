...
export class ArcManagArchiveLocationComponent implements OnInit {
  ...
  routeLoadDataTablesService: string =
    environment.versionApiDefault + "gestionArchivo/gestion-archivo/view";
  ...
  filteredlistDepart: ReplaySubject<ListaBusq[]> = new ReplaySubject<
    ListaBusq[]
  >(1);
  filteredlistMunicipios: ReplaySubject<ListaBusq[]> = new ReplaySubject<
    ListaBusq[]
  >(1);
  filteredlistEdificio: ReplaySubject<ListaBusq[]> = new ReplaySubject<
    ListaBusq[]
  >(1);
  filteredlistPiso: ReplaySubject<ListaBusq[]> = new ReplaySubject<ListaBusq[]>(
    1,
  );
  filteredlistBodega: ReplaySubject<ListaBusq[]> = new ReplaySubject<
    ListaBusq[]
  >(1);
  filteredlistPasillo: ReplaySubject<ListaBusq[]> = new ReplaySubject<
    ListaBusq[]
  >(1);
  filteredlistModulo: ReplaySubject<ListaBusq[]> = new ReplaySubject<
    ListaBusq[]
  >(1);
  filteredlistEntrepano: ReplaySubject<ListaBusq[]> = new ReplaySubject<
    ListaBusq[]
  >(1);
  filteredlistCaja: ReplaySubject<ListaBusq[]> = new ReplaySubject<ListaBusq[]>(
    1,
  );
  filteredlistCajas: ReplaySubject<ListaBusq[]> = new ReplaySubject<
    ListaBusq[]
  >(1);
  ...
  constructor(
    ...
    this.moduleForm = this.formBuilder.group({
      idExpediente: new UntypedFormControl(
        "",
        Validators.compose([
          // Validators.required
        ]),
      ),
      idDepartamentoGaEdificio: new UntypedFormControl(
        "",
        Validators.compose([Validators.required]),
      ),
      idMunicipioGaEdificio: new UntypedFormControl(
        "",
        Validators.compose([Validators.required]),
      ),
      idGaEdificio: new UntypedFormControl(
        "",
        Validators.compose([Validators.required]),
      ),
      idGaPiso: new UntypedFormControl(
        "",
        Validators.compose([Validators.required]),
      ),
      idGaBodega: new UntypedFormControl(
        "",
        Validators.compose([Validators.required]),
      ),
      unidadConservacionGaArchivo: new UntypedFormControl(
        1,
        Validators.compose([Validators.required]),
      ),
      pasilloGaArchivo: new UntypedFormControl(
        "",
        Validators.compose([Validators.required]),
      ),
      moduloGaArchivo: new UntypedFormControl(
        "",
        Validators.compose([Validators.required]),
      ),
      listRackFilter: new UntypedFormControl(
        "",
        Validators.compose([Validators.required]),
      ),
      entrepanoGaArchivo: new UntypedFormControl(
        "",
        Validators.compose([Validators.required]),
      ),
      cajaGaArchivo: new UntypedFormControl(
        "",
        Validators.compose([Validators.required]),
      ),
      unidadCampoGaArchivo: new UntypedFormControl(
        "",
        Validators.compose([Validators.required]),
      ),
      caja_id: new UntypedFormControl(
        "",
        Validators.compose([Validators.required]),
      ),
      idGaBodegaContenido: new UntypedFormControl(
        "",
        Validators.compose([Validators.required]),
      ),
       ...
       */
      listDepartFilter: new UntypedFormControl(
        "",
        Validators.compose([
          // Validators.required
        ]),
      ),
      listMunicipiosFilter: new UntypedFormControl(
        "",
        Validators.compose([
          // Validators.required
        ]),
      ),
      listEdificioFilter: new UntypedFormControl(
        "",
        Validators.compose([
          // Validators.required
        ]),
      ),
      listPisoFilter: new UntypedFormControl(
        "",
        Validators.compose([
          // Validators.required
        ]),
      ),
      listBodegaFilter: new UntypedFormControl(
        "",
        Validators.compose([
          // Validators.required
        ]),
      ),
      listPasilloFilter: new UntypedFormControl(
        "",
        Validators.compose([
          // Validators.required
        ]),
      ),
      listModuloFilter: new UntypedFormControl(
        "",
        Validators.compose([
          // Validators.required
        ]),
      ),
      listEntrepanoFilter: new UntypedFormControl(
        "",
        Validators.compose([
          // Validators.required
        ]),
      ),
      listCajaFilter: new UntypedFormControl(
        "",
        Validators.compose([
          // Validators.required
        ]),
      ),
      listCajasFilter: new UntypedFormControl(
        "",
        Validators.compose([
          // Validators.required
        ]),
  ...
  getCallUrl(authori) {
    ...
    this.restService
      .restGetParams(this.versionApi + this.reuteLoadView, params, authori)
      .subscribe(
        (res) => {
            ...
            .then((res) => {
              ...
              if (responseResolveResponse == true) {
                if (this.responseServiceView) {
                  ...
                  this.statusExpedient =
                    this.responseServiceView.statusExpedient;
                }
              }
            });
        },
  ...
  patchValuesForm() {
    this.moduleForm.controls["idDepartamentoGaEdificio"].valueChanges.subscribe(
      (e) => {
        this.getListMunicipio(
          this.moduleForm.controls["idDepartamentoGaEdificio"].value,
        );
  ...
  editLocationForm() {
    ...
    const data = {
      ...
      unidadConservacionGaArchivo:
        this.moduleForm.getRawValue()["unidadConservacionGaArchivo"],
      ...
      unidadCampoGaArchivo:
        this.moduleForm.getRawValue()["unidadCampoGaArchivo"],
    ...
    this.restService
      .restPut(
        `${this.versionApi}api/gestion-archivo/archivo/${this.idLocationFile}`,
        data,
        this.authorization,
      )
      .subscribe(
    ...
    this.restService
      ...
      .subscribe(
        (data) => {
          ...
          // Evaluar respuesta del servicio
          this.globalAppService
            .resolveResponse(this.resSerlistDepart)
            .then((res) => {
              let responseResolveResponse = res;
              if (responseResolveResponse == true) {
        ...
        (err) => {
          ...
          // Evaluar respuesta de error del servicio
          this.globalAppService
            .resolveResponseError(this.resSerlistDepartErr)
            .then((res) => {});
        },
      );
  }
    ...
    this.restService
      ...
      .subscribe(
        (data) => {
          ...
          // Evaluar respuesta del servicio
          this.globalAppService
            .resolveResponse(this.resSerlistMunicipios)
            .then((res) => {
              let responseResolveResponse = res;
              if (responseResolveResponse == true) {
                this.listMunicipios =
                  this.resSerlistMunicipios.dataNivelGeografico3;
                // load the list initial
        ...
        (err) => {
          ...
          // Evaluar respuesta de error del servicio
          this.globalAppService
            .resolveResponseError(this.resSerlistMunicipiosErr)
            .then((res) => {});
        },
      );
  }
  ...
  getListGeneral(val) {
    ...
    this.restService
      .restGetParams(
        this.versionApi + "gestionArchivo/gestion-archivo/get-general-list",
      ...
      .subscribe(
        (data) => {
          ...
          // Evaluar respuesta del servicio
          this.globalAppService
            .resolveResponse(this.resSerListGeneral)
            .then((res) => {
              let responseResolveResponse = res;
              if (responseResolveResponse == true) {
                // Lista edificios
                ...
                if (this.resSerListGeneral.dataUConservacionGaArchivo) {
                  this.dataUConserva =
                    this.resSerListGeneral.dataUConservacionGaArchivo;
                }
                // Lista Estantes
                ...
                if (this.resSerListGeneral.dataEntrepanoGaBodega) {
                  this.listEntrepano =
                    this.resSerListGeneral.dataEntrepanoGaBodega;
                  // load the list initial
                ...
                this.moduleForm.controls["idGaBodegaContenido"].setValue(
                  this.resSerListGeneral.dataIdGaBodegaContenido,
                );

                if (this.resSerListGeneral.dataArchivo) {
                  for (let name in this.resSerListGeneral.dataArchivo) {
                    if (
                      this.moduleForm.controls[name] &&
                      this.resSerListGeneral.dataArchivo[name] != "" &&
                      this.resSerListGeneral.dataArchivo[name] != 0
                    ) {
                      // Asigna el valor
